...
describe("checkModule", () => {
  ...
  test.each([
    ...
    [
      "mixed numeric types",
      `import type { int32 } from "@lucent-lang/core/types"; export function f(a: int32, b: number): number { return a + b; }`,
      ["LUCENT1011"],
    ],
    [
      "fractional literal into int",
      `import type { int32 } from "@lucent-lang/core/types"; export function f(): int32 { return 1.5; }`,
      ["LUCENT1011"],
    ],
