...
export const Explanations: Record<Code, Explanation> = {
  ...
  LUCENT1002: {
    ...
    summary:
      "An operator used outside what the subset supports, such as `delete`, `in` on anything but a record, or `instanceof` with a generic class.",
    details:
  ...
  LUCENT1004: {
    ...
    summary:
      "A destructuring form outside the subset: object rest, computed keys, or a pattern without an initializer.",
    details:
  ...
  LUCENT1008: {
    ...
    summary:
      "An assignment to something that cannot be assigned, such as an unknown field or a function.",
    details:
  ...
  LUCENT2002: {
    ...
    summary:
      "A type with no native representation: intersections, `bigint`, `symbol`, `object`, `WeakMap`, `Intl`, or an index signature mixed with properties.",
    details:
  ...
  LUCENT2003: {
    ...
    summary:
      "An object used as a type with a different shape; object types must match exactly to share a native representation.",
    details:
  ...
  LUCENT2005: {
    ...
    summary:
      "A union JavaScript values cannot be told apart by at the boundary; add a string-literal discriminant.",
    details:
    ...
    right: ex(
      'export function area(shape: { kind: "circle"; radius: number } | { kind: "square"; side: number }): number {\n  return shape.kind === "circle" ? Math.PI * shape.radius ** 2 : shape.side ** 2;\n}\n',
    ),
  },
  LUCENT2006: {
    title: "Value that cannot cross the JavaScript boundary",
    summary:
      "A value that cannot cross the JavaScript boundary, such as a generator, a match result, an `AbortSignal` or a platform object.",
    details:
  ...
  LUCENT2009: {
    ...
    summary:
      "A class member whose native signature differs from the interface member it implements.",
    details:
  ...
  LUCENT3001: {
    ...
    summary:
      "An import from something other than another `*.lucent.ts` file or a built-in `lucent:` module.",
    details:
  ...
  LUCENT3002: {
    ...
    right: ex(
      'const cache = new Map<string, number>([["zero", 0]]);\nexport function lookup(k: string): number | undefined {\n  return cache.get(k);\n}\n',
    ),
  },
  LUCENT3003: {
  ...
  LUCENT3004: {
    ...
    summary:
      "A platform SDK import in a file whose platform cannot use it, an SDK module without bindings, or platform code used outside its platform.",
    details:
