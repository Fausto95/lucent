...
function write(name: string, content: string): void {
  ...
  if (check) problems.push(`apps/website/src/generated/${name} is stale: run \`node scripts/website.ts\``);
  else {
...
for (const name of fs.readdirSync(schemasDir)) {
  ...
  if (check) problems.push(`apps/website/public/schemas/${name} is stale: run \`node scripts/website.ts\``);
