    ...
    entries: [
      {
        ...
        description:
          "Lucent compiles TypeScript modules to C++ for React Native: you write a `.lucent.ts` file, and your app calls it as native code.",
      },
      {
        slug: "install",
        kind: "start",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "A CoreLocation delegate and an Android listener that call a JS function with each new position.",
      ...
      },
      {
        ...
        description:
          "The permission prompt, the `Info.plist` entry, and Android permissions added for you.",
      ...
      },
      {
        ...
        description:
          "The trip tracker as an npm package that apps install and compile with their own modules.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "Decide what JavaScript calls before writing the module: plain data, few calls over data that stays native, `async` for slow work, errors with codes.",
      },
      {
        ...
        description:
          "Keep logic in shared code and SDK calls in small platform branches of the same module. Split into platform files only when the halves share nothing.",
      },
      {
        ...
        description:
          "Sync exports run on the JS thread, async ones on the Lucent thread, and `main()` on the main thread. One lock keeps Lucent code from racing itself.",
      },
      {
        ...
        description:
          "Objects are freed when their last reference goes. Break cycles, remove delegates and listeners, and close sessions yourself.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Swift and Kotlin concepts map to Lucent one to one. A module written in Swift, Kotlin and a JS binding becomes one Lucent module.",
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        description:
          "Import a framework from `lucent:ios/*` and call it with Swift's names, inside `main()` when it's main-thread only.",
      },
      {
        ...
        description:
          "Import a package from `lucent:android/*` and call it with Java's names, from the app's `Context`.",
      },
      {
        ...
        description:
          "`lucent sdk search` finds classes and members with the import to copy; `lucent sdk show` prints what Lucent code sees.",
      },
      {
        ...
        description:
          "A class that `implements` the SDK's protocol or interface, kept alive while the SDK calls it.",
      },
      {
      ...
      },
      {
        ...
        description:
          "A function parameter: called at once during a synchronous call, posted to the JS thread from async code.",
      },
      {
      ...
      },
      {
        ...
        title: "Cancel work",
        description:
          "Take an `AbortSignal` from JavaScript and check it; the promise rejects with an `AbortError`.",
      },
      {
      ...
      },
      {
        ...
        description:
          "`error(code, message)` throws an error JavaScript receives with its `code`. Errors from JavaScript and the SDK arrive the same way.",
      },
      {
        ...
        description:
          '`available("ios", 17)` and `available("android", 31)` guard newer APIs. On Android, the compiler requires it.',
      },
      {
        ...
        description:
          "One module with a platform branch per SDK call; platform files only when the halves share nothing.",
      },
      {
        ...
        description:
          "Android permissions come from the SDK; iOS usage descriptions go in `Info.plist` or `app.json`.",
      },
      {
        ...
        description:
          "Add the pod or Gradle dependency to the app as usual, then import it from `lucent:ios/*` or `lucent:android/*`.",
      },
      {
        ...
        description:
          "An npm package with a `lucent` field in `package.json`, its modules as source, and a `lucent.json` for its native needs.",
      },
      {
        ...
        description:
          "Install it with npm: `lucent build` compiles its modules with the app's, with their pods, dependencies and permissions.",
      },
      {
        ...
        description:
          "Keep the TypeScript API, and write the Swift and Kotlin bodies as the two branches of one Lucent module.",
      },
      {
        ...
        description:
          "The spec becomes the module's exports, hybrid objects become classes, and codegen goes away.",
      },
      {
        ...
        title: "Test a module",
        description:
          "Run shared modules in Jest or Vitest as TypeScript, compare native and JavaScript with `lucent bench`, and check SDK calls on devices.",
      },
      {
        ...
        title: "Debug a crash",
        description:
          "Errors carry their `.lucent.ts` line to JavaScript, logs go to the unified log and logcat, and native crashes point at your source.",
      },
      {
        ...
        description:
          "`lucent bench` times each case natively and as JavaScript, and shows the speedup.",
      },
      {
        slug: "guides/upgrade",
        kind: "guide",
    ...
    entries: [
      {
        ...
        description:
          "Every TypeScript feature: whether Lucent supports it, and what to write instead when it doesn't.",
      },
      {
        ...
        title: "Built-ins",
        description:
          "The JavaScript built-ins Lucent has, and where they differ from JavaScript's.",
      },
      {
        ...
        description:
          "How each type crosses between JavaScript and Lucent: its C++ form, copy or reference, and what JavaScript must pass.",
      },
      {
        ...
        title: "SDK types",
        description:
          "How iOS and Android SDK declarations appear in Lucent: names, nullability, enums, errors, callbacks.",
      },
      {
    ...
    entries: [
      {
        ...
        description:
          "Ports of popular Expo and community modules, each one Lucent module for both platforms, running in the repository's example apps.",
      },
      {
        ...
        title: "Clipboard",
        description:
          "`expo-clipboard`'s text API on `UIPasteboard` and Android's `ClipboardManager`.",
      },
      {
        ...
        title: "Location",
        description:
          "`expo-location`'s API on CoreLocation and Android's `LocationManager`: permission, current position, and positions sent to JavaScript as they arrive.",
      },
      {
      ...
      },
      {
        ...
        title: "Secure store",
        description:
          "`expo-secure-store`'s API on the iOS Keychain and the Android Keystore, shipped as a Lucent package.",
      },
      {
        ...
        title: "Haptics",
        description:
          "`expo-haptics`' API on UIKit's feedback generators and Android's `Vibrator`, shipped as a Lucent package.",
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        description:
          "What each one has you write, how it reaches native code, what it can do today, and when to pick it.",
      },
      {
        slug: "faq",
        kind: "other",
        ...
        description:
          "Short answers to the questions people ask first, each with a link to the details.",
      },
      {
        slug: "roadmap",
        kind: "other",
...
export function findDoc(slug: string): DocLookup | undefined {
  ...
  const next =
    entry.next === undefined
      ? flat[index + 1]?.entry
      : flat.find((f) => f.entry.slug === entry.next)?.entry;
