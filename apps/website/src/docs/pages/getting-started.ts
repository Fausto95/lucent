...
export const page: DocPage = {
  ...
  blocks: [
          ...
          blocks: [
            {
              kind: "code",
              filename: "terminal",
              code: "npx expo install @lucent-lang/runtime @lucent-lang/types @lucent-lang/expo @lucent-lang/metro",
            },
          ],
        },
        {
    ...
    {
      kind: "p",
      text: "Add the declaration packages for what you use. They contain TypeScript types only; nothing from them runs at runtime.",
    },
    {
      kind: "table",
      ...
      rows: [
        ...
        ["`@lucent-lang/core`, `@lucent-lang/platform`", "the [built-in library](/docs/api/std/)"],
