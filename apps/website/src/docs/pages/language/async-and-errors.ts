...
export const page: DocPage = {
  ...
  blocks: [
    ...
    {
      kind: "p",
      text: "`LucentError` is a global the compiler knows; it needs no import. Throw it with a code, an optional message and optional scalar metadata. Any other thrown value is `NT1001`.",
    },
    {
      kind: "code",
