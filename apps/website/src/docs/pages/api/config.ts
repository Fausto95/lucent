...
export const page: DocPage = {
  ...
  blocks: [
    ...
    {
      kind: "p",
      text: "`lucent build`, `lucent check` and the Metro transformer compare each module's required capabilities (declared by the package bindings it reaches) against this allowlist and report `LC2001` for anything missing. Runtime permission prompts stay the app's responsibility.",
    },
  ],
};
