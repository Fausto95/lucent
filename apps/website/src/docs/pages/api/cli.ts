...
export const page: DocPage = {
  ...
  blocks: [
    ...
    },
    {
      kind: "code",
      filename: "terminal",
      code: 'lucent check --json\n# { "ok": false, "files": [{ "file": "src/geo.lucent.ts", "ok": false,\n#     "diagnostics": [{ "code": "LUCENT1014", "severity": "error", "message": "…", "line": 4, "column": 14, "help": "…" }] }],\n#   "durationMs": 12 }',
    },
    ...
    {
      kind: "p",
      text: "`lucent explain LUCENT1004` prints the code's title, its family (language, platform, or warning) and a link to the [diagnostics reference](/docs/language/diagnostics/). Without a code it lists every diagnostic Lucent can report. Codes are case-insensitive and a near miss gets a suggestion.",
    },
