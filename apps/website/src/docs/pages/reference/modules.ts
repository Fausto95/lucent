...
const intros: Record<string, string> = {
  "lucent:core":
    "Helpers for any module: delays, errors with codes, UTF-8, a monotonic clock. Its JavaScript version, `@lucent-lang/lucent/core`, lets tests run modules as TypeScript ([Test a module](/docs/guides/test-a-module/)).",
