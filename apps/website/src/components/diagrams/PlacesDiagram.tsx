...
export function PlacesDiagram() {
  return (
    <DiagramSvg viewBox="0 0 440 470" markerId={m} title="The three places your code runs, and what crosses between them">
      <DiagramLane x={10} y={10} w={420} h={80} label="1 · THE JS APP" />
      <DiagramBox x={80} y={36} w={280} label="your components and JS code" sub="Hermes, on the JS thread" accent />
      ...
      <DiagramBox x={80} y={406} w={280} label="your module's C++ · the SDKs" sub="JS thread · Lucent thread · main thread" accent />
