// Generated from packages/compiler/test/e2e/cases/regexps.test.js. Do not edit.
// @ts-nocheck
export default function run(mod, print, lucentClass, mods) {
  ...
  print(mod.flags());
  print(mod.sticky());
  print(mod.dynamic("a+", "g", "caaab aa"), mod.dynamic("(", "", "x"), mod.dynamic("x", "gg", "x"), mod.dynamic("\\d", "", "abc"));
