...
export default function setup(): void {
  if (sdkAvailable("ios", { prebuilt: false })) prefetch("ios", ["UIKit", "Foundation", "Security"]);
  if (sdkAvailable("android", { prebuilt: false })) prefetch("android", ["android.os", "android.content", "android.util"]);
}
